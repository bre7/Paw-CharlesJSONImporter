...
# The file where your importer is
file = 'CharlesJSONImporter.coffee'

# Your importer identifier
# Should be same with the `identifier` property of your importer class
identifier = 'PawExtensions.CharlesJSONImporter'
#
# End
#
